...
export default function AddTransactionModal({ userId, accounts }: AddTransactionModalProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetPortal>
        ...
        >
          <SheetTitle className="sr-only">新規取引の追加</SheetTitle>
          ...
          <div className="pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold">新規取引の追加</h2>
