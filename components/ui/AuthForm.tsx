...
import { getLoggedInUser, singIn, singUp } from '@/lib/actions/user.actions'
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}
              className='space-y-8'>
                ...
                <div className='flex gap-4'>
                <CustomInput
                control={form.control} name='state' label='State' placeholder='Enter your specific address'
                />
                <CustomInput
                control={form.control} name='postalCode' label='Postal Code' placeholder='Enter your specific address'
                />
                </div>
                <CustomInput
                control={form.control} name='dateOfBirth' label='DateofBirth' placeholder='YYYY-MM-DD'
                />
                  </>
                )}
